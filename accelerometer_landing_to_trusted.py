...
AccelerometerLanding_node1745414943311 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="accelerometer_landing", transformation_ctx="AccelerometerLanding_node1745414943311")

# Script generated for node Customer Trusted
CustomerTrusted_node1745414991849 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="customer_trusted", transformation_ctx="CustomerTrusted_node1745414991849")

# Script generated for node Join
Join_node1745415021765 = Join.apply(frame1=CustomerTrusted_node1745414991849, frame2=AccelerometerLanding_node1745414943311, keys1=["email"], keys2=["user"], transformation_ctx="Join_node1745415021765")
